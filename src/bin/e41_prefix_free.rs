use nqueens_peps_naive::{contract_rows_prefix_free_fast_tail, known_count};
use std::env;
...
fn run() -> Result<(), String> {
    ...
    if args.next().is_some() || min_n > max_n || repeats == 0 {
        return Err("usage: e41_prefix_free MIN_N MAX_N REPEATS WARMUP".to_owned());
    }
    println!(
        "N,count,verified,median_elapsed_s,min_elapsed_s,p10_elapsed_s,p90_elapsed_s,\
         peak_rss_bytes,threads,split_depth,target_tail_tasks,tail_tasks,prefix_nodes,\
         prefix_accepted_entries,prefix_kept_entries,recursive_nodes,\
         recursive_accepted_entries,total_accepted_entries,used_u64_fast_path,seed_s,\
    ...
    for n in min_n..=max_n {
        ...
        println!(
            "{n},{},{verified},{:.9},{:.9},{:.9},{:.9},{peak_rss},{},{},{},{},{},{},\
             ...
             certified_explicit_C_prefix_free_PEPS,{},{},{}",
